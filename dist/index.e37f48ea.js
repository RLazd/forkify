...
const controlSearchResults = async function() {
    try {
        ...
        //! Sort Recipes View
        (0, _sortRecipesViewJsDefault.default)._renderMarkupSort();
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./views/sortRecipesView.js":"d0aKU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const sortSearchResults = async function() {
    const urls = state.search.results.map((rec)=>`${0, _configJs.API_URL}${rec.id}?key=${0, _configJs.KEY}`);
...
const KEY = "c03929ed-81a9-4a9e-80b2-331c868d3611";
...
var _iconsSvg = require("../../img/icons.svg"); //url: used for static assets
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _fracty = require("fracty"); //any packages from npm -> no neet to specify path
var _fractyDefault = parcelHelpers.interopDefault(_fracty);
class RecipeView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector(".recipe");
    _errorMessage = "We couldn't find this recipe. Please try another!";
    _successMessage = "";
...
class SearchView {
    ...
    _clearInput() {
        this._parentElement.querySelector(".search__field").valu = "";
    }
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _successMessage = "Uploaded successfuly!";
...
class SortRecipesView extends (0, _viewJsDefault.default) {
    ...
    _renderMarkupSort() {
        this._clear();
        this._parentElement.insertAdjacentHTML("afterbegin", this._generateMarkupSort());
    }
    _clear() {
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"dXNgZ":[function(require,module,exports) {
/**
